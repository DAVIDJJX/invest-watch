...
| 2026-09-26 | 分析系列 A1-5：儀表板整合第一版（卡片的「分析」摺疊區、分析分頁、舊網址跳轉、docs 大小上限守門） | `git revert -m 1 bc028ac && git push`（它是 2520c18 之後的第一個合併；退回後分析分頁與卡片摺疊區消失、analysis-debug.html 變回表格頁，資料檔不受影響） |
